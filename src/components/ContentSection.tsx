    ...
    return (
        <section className="bg-black py-20 px-4 sm:px-6 lg:px-8 border-t border-white/5">
            <div className="max-w-5xl mx-auto">
                {/* CTA Section */}
                <div className="relative text-center py-16 px-6 rounded-2xl border border-white/10 bg-gradient-to-b from-orange-500/5 to-transparent overflow-hidden">
                ...
                <div className="mt-12 flex items-center justify-center gap-4">
                    <Link 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="group flex items-center gap-2 px-4 py-2.5 rounded-lg border border-white/10 hover:border-white/20 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-300"
                    >
                    ...
                    <Link 
                        ...
                        className="group flex items-center gap-2 px-4 py-2.5 rounded-lg border border-white/10 hover:border-white/20 bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-300"
                    >
                        <MessageCircle className="w-5 h-5 text-gray-400 group-hover:text-indigo-400 transition-colors" />
