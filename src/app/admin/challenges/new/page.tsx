    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                throw new Error(data.message || data.error?.message || 'Failed to create challenge');
            }
        } catch (err: unknown) {
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="p-6 rounded-2xl border border-white/10 bg-white/[0.02] space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <InputLabel title="Instance URL / Connection String" desc="e.g. http://104.248.1.1:8080 or nc 104.248.1.1 4000" />
                                <input type="text" value={form.instanceUrl} onChange={e => setForm({ ...form, instanceUrl: e.target.value })} className={inputClass} placeholder="http://..." disabled={form.instanceType === 'static'} />
                            </div>
                        </div>
                    </div>
