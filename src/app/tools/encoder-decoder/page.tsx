    ...
    return (
        <div className="min-h-screen pt-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
                <div className="mb-8">
                    <Link href="/tools" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-white mb-4 transition-colors">
                        <ArrowLeft className="w-4 h-4" /> Back to Tools
                    </Link>
                    <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Encoder / Decoder</h1>
                    <p className="text-gray-400">Encode and decode text using various formats.</p>
                </div>
