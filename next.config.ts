        ...
        return [
            {
                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.google-analytics.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https://crt.sh https://www.google-analytics.com https://9b5gemj3ff.execute-api.us-east-1.amazonaws.com; frame-ancestors 'none';",
                    },
                ],
            },
            // Cache static assets
